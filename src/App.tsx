  ...
  const days = [
    {
      date: '17 квітня',
      events: [
        { time: '08:30', title: 'Реєстрація / Ранкові теревені', desc: 'Початок конференції, час для спілкування.' },
        ...
        { time: '12:30', title: 'Перерва на теревені', desc: 'Час для нетворкінгу та кави.' },
        ...
        { time: '16:00', title: 'Перерва на теревені', desc: 'Відпочинок та обговорення воркшопів.' },
    ...
    },
    {
      date: '18 квітня',
      events: [
        { time: '09:00', title: 'Ранкові теревені', desc: 'Початок другого дня, кава та спілкування.' },
        ...
        { time: '11:30', title: 'Перерва на теревені', desc: 'Коротка пауза для спілкування.' },
